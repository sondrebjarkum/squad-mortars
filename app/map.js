...
const getMapConfig = (tilesSize, id = "map") => {
  ...
  const imageBounds = L.latLngBounds(L.latLng(0, 0), L.latLng(-tilesSize, tilesSize));
...
export function setupMap() {
  ...
  const layer = L.tileLayer("maps" + activeMap.mapURL + "basemap" + "/{z}_{x}_{y}.webp", { maxNativeZoom: 4, maxZoom: 7 });
